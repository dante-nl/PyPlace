...
while invalid_input == True:
	...
	if input_to_handle == "1":
		...
		ask_translation("[o]WARNING:[\] It appears that you're running this on the Replit page! We recommend downloading PyPlace and running it for yourself.", "replit_warning")
		...
		ask_translation("[g]The latest version of PyPlace is now ready!", "update_message_6")
		ask_translation("Would you like to run it?", "update_message_7")
		ask_translation("[i]Attempting to run PyPlace[\]", "update_message_8")
		ask_translation("Continuing with current version. [b]NOTE:[\] Next time you start PyPlace, it will be on the latest version!", "update_message_9")
		...
		ask_translation("[g]The latest version of PyPlace is now ready![\]", "settings_message_7")
		ask_translation("Would you like to run it?", "settings_message_8")
		ask_translation("[i]Attempting to run PyPlace...[\]", "settings_message_9")
		ask_translation("Continuing with current version. [b]NOTE:[\] Next time you start PyPlace, it will be on the latest version!", "settings_message_10")
		...
		ask_translation("Would you like to update the following app(s) to the latest version?", "app_updater_message_3")
